...
import { getMyMentors, getMyReqMentors, getMyTopMentors, menteeCancelReq, menteeFollowReq, menteeUnFollowReq, updateUserList } from '../../services/userList';
...
export const Mentors = () => {
    ...
    const [mentorType, setMentorType] = useState(mentortype ?? state?.type === "requestmentor" ? "requestmentor" : 'mymentor')
                ...
                return <>
                    ...
                    >
                        ...
                        <MenuItem onClick={() => {
                            ...
                            <img src={CloseRequest} alt="FollowIcon" className='pr-3 w-[27px]' />
                            Cancel Request
                        </MenuItem>
                    </Menu>
                </>
    ...
    const getMentorDatas = (type = mentorType) => {
        if (type === "topmentor") {
            ...
            dispatch(getMyReqMentors({ page: paginationModel?.page + 1, limit: paginationModel?.pageSize, status: requestTab }))
        } else {
    ...
    const handleSearch = (value) => {
        ...
        if (mentorType === "topmentor") {
            ...
            dispatch(getMyReqMentors({ page: paginationModel?.page + 1, limit: paginationModel?.pageSize, search: value, status: requestTab }))
        } else {
    ...
    const handleTabSwitch = (value) => {
        handleTab(value)
        dispatch(getMyReqMentors({ page: paginationModel?.page + 1, limit: paginationModel?.pageSize, search: search, status: value }))
    }
        ...
        <div className="px-9 py-9">
            ...
            <div className='px-3 py-5' style={{ boxShadow: '4px 4px 25px 0px rgba(0, 0, 0, 0.15)' }}>
                ...
                <div className='mx-5'>
                    ...
                    <DataTable rows={mentorList?.results} columns={mentorType === "requestmentor" ? reqMentorColumn : mentorColumn} hideCheckbox
            ...
            >
                ...
                <div className="popup-content w-2/6 bg-white flex flex-col gap-2 h-[330px] p-[12px] justify-center items-center">
                    <div className='border border-[#E50027] rounded-[15px] h-[100%] w-[100%] justify-center items-center flex flex-col relative'>
                        <div className='absolute top-[12px] right-[12px] cursor-pointer' onClick={() => handleCloseCancelPopup()}>
