    ...
    switch (actionType) {
      ...
      case 'certificate':
        const certificateurl =
          role === 'mentor'
            ? `certificate_mentees/${data.related_data.certificate_id}`
            : `certificate_mentees/${data.related_data.certificate_id}?request_id=${data.related_data?.certificate_request_id}`;
        handleClose && handleClose();
