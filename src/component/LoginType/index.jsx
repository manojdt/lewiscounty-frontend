      ...
      <div className="flex flex-wrap h-full">
        <div className="min-h-screen w-full">
          ...
          >
            <div className="p-2">
              <div
                className="border border-black rounded-full h-[30px] w-[30px] flex items-center cursor-pointer"
                onClick={() => handleBack()}
              >
            ...
            >
              <h6 className="text-4xl font-semibold text-center text-gray-800 mt-6 mb-4">
                {"Welcome!"}
              </h6>
              <p className="text-center text-lg">
                {
                  "Thank you for your interest in our mentoring program. All information collected on this application will be kept confidential within the mentoring program. Click next to continue"
                }
              </p>
            </MuiCustomModal>
          </div>
