...
import { getMentorProgramActivity, getMyMentorInfo } from '../../services/userList';
...
export default function MentorDetails() {
    ...
    const { mentorDetails, loading } = useSelector(state => state.userList)
    ...
    return (
        <div className="px-9 my-6 grid">
            ...
            {
                Object.keys(mentorDetails).length &&
                                ...
                                <div className="col-span-2">
                                    <div className='flex flex-col'>
                                        <div className='mentor-details flex py-4 px-4 items-center' style={{ border: '1px solid rgba(29, 91, 191, 1)', borderRadius: '3px' }}>
                                            ...
                                            <div className='pl-4'>
                                                <div>{mentorDetails?.first_name}{' '}{mentorDetails.last_name} (Software Developer)</div>
