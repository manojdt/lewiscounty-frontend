              ...
              >
                {
                  ...
                  <span className="absolute notification-count" style={{background: 'rgba(255, 206, 71, 1)', right: '4px', top: '-7px', height: '23px', width: '23px', 
                    textAlign: 'center', borderRadius: '50%', color: '#fff'}}>{renderData.length}</span>
                }
