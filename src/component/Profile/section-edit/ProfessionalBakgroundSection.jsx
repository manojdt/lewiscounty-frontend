...
import { ProfessionalBackgroundFields } from '../../../utils/formFields';
import { view } from '../../../utils/constant';

const ProfessionalBakgroundSection = ({ type }) => {
  const {
    register,
    formState: { errors },
    handleSubmit,
  ...
  return (
    <div className='grid grid-cols-4 gap-6'>
      {ProfessionalBackgroundFields.map((field) => {
        switch (field.type) {
          case 'input':
            return (
              <div
...
export default ProfessionalBakgroundSection;
