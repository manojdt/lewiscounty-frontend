...
import { GoalsandExperienceFields } from '../../../utils/formFields';
import { view } from '../../../utils/constant';

const GoalsAndExpectatonsSection = ({ type }) => {
  const {
    register,
    formState: { errors },
    handleSubmit,
  ...
  return (
    <div className='grid grid-cols-1 gap-6'>
      {GoalsandExperienceFields.map((field) => {
        switch (field.type) {
          case 'input':
            return (
              <div
...
export default GoalsAndExpectatonsSection;
