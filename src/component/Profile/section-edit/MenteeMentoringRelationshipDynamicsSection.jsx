...
const MenteeMentoringRelationshipDynamicsSection = ({ type }) => {
  const {
    register,
    formState: { errors },
    handleSubmit,
  ...
  return (
    <div className='grid grid-cols-2 gap-6'>
      {MenteeMentoringRelationshipFields.map((field) => {
        switch (field.type) {
          case 'input':
            return (
              <div
...
export default MenteeMentoringRelationshipDynamicsSection;
