...
import { MenteeExpectationGoalsFields } from '../../../utils/formFields';

const MenteeExpectionAndGoalsSection = ({ type }) => {
  ...
  return (
    <div className='grid grid-cols-2 gap-6'>
      {MenteeExpectationGoalsFields.map((field) => {
        switch (field.type) {
          case 'input':
            return (
              <div
...
export default MenteeExpectionAndGoalsSection;
