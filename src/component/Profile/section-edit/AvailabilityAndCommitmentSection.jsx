...
import { AvailabilityCommitmentFields } from '../../../utils/formFields';
import { Controller, useFormContext } from 'react-hook-form';
import { view } from '../../../utils/constant';

const AvailabilityAndCommitmentSection = ({ type }) => {
  const {
    register,
    formState: { errors },
    handleSubmit,
  ...
  return (
    <div className='grid grid-cols-1 gap-6'>
      {AvailabilityCommitmentFields.map((field) => {
        switch (field.type) {
          case 'input':
            return (
              <div
...
export default AvailabilityAndCommitmentSection;
