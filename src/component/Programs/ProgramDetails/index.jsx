...
import {
  ...
  programNotLaunched,
  programNotStarted,
  programRequestApproval,
  programWaitingActiveApproval,
  requestStatus,
} from '../../../utils/constant';
import {
  acceptProgram,
...
console.log(requestStatusParams,"requestStatusParams")
  ...
  const handleMenteeAcceptCancelRequest = (type, id) => {
    if (type === 'approve') {
      setConfirmPopup({ ...confirmPopup, accept: true });
    }
    if (type === 'reject') {
      setConfirmPopup({ ...confirmPopup, cancel: true });
    }
  };
  ...
  //     console.log(payment?.paymentData?.data?.client_secret);
  //     setClientSecret(payment?.paymentData?.data?.client_secret);
  //     navigate('/payments');
  //   }
  // }, []);
                        ...
                        programApprovalStage[programdetails.status] ? (
                          ...
                          <div className='py-9'>
                            <button
                              ...
                              onClick={() =>
                                handleJoinProgram(programdetails.id)
                              }
                            >
                              Launch Program
