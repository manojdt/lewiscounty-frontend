  ...
  return (
    <div
      ...
      style={{
        ...
        borderRadius: '10px',
        height:
          role === 'mentee' && !height ? '528px' : height ? height : 'auto',
      }}
    >
          ...
          <>
            ...
            >
              {action.map((act, i) => (
                ...
                >
                  {act.icon && (
                    <img src={act.icon} alt='Icon' className='pr-3 w-[30px]' />
                  )}
                  {act.name}
                </MenuItem>
              ))}
      ...
      <div className='py-3 px-3 '>
        {programs &&
        programs.length > (getWindowDimensions().width <= 1536 ? 2 : 3) ? (
          <Carousel slideCount={getWindowDimensions().width <= 1536 ? 2 : 3}>
            {programs &&
              programs.map((curatedProgram, index) => {
                let startDate = '';
                if (curatedProgram.start_date !== '') {
                  startDate = new Date(curatedProgram.start_date)
                    .toISOString()
                    .substring(0, 10)
                    .split('-');
                }
                ...
                return (
                  <div
                    key={index}
                    className='curated-programs program-container flex gap-0 items-center py-8 px-5 w-2/5'
                  >
                    <div
                      className='w-full'
                      style={{
                      ...
                      <div className='flex py-6 px-7 border-b-2 relative gap-3'>
                        ...
                        <div className='flex flex-col gap-3 w-[80%]'>
                          ...
                          <div className='flex gap-2 text-[12px]'>
                            ...
                            <span>4.6</span>
                            <span
                              style={{ borderRight: '1px solid #18283D' }}
                            ></span>
                            <span
                              style={{
                            ...
                            >
                              Instructor : {curatedProgram?.mentor_name}
                            </span>
                          </div>

                          <button
                            className='text-white text-[12px] py-2 w-[90px]'
                            style={{
                              background: 'rgba(29, 91, 191, 1)',
                              borderRadius: '5px',
                            }}
                            onClick={() =>
                              handleNavigateDetails(curatedProgram)
                            }
                          >
                            View Details
                          </button>
                        ...
                        <img
                          ...
                          onClick={() => handleBookmark(curatedProgram)}
                          src={
                            curatedProgram.bookmark
                              ? BookmarkedColorIcon
                              : BookmarkedIcon
                          }
                          alt='BookmarkedIcon'
            ...
            {programs.length ? (
              programs.map((currentProgram, index) => {
                ...
                return (
                  <div
                    key={index}
                    className={`curated-programs program-container flex gap-1 items-center py-8 px-5 
                                                            ${
                                                              getWindowDimensions()
                                                                .width <= 1536
                                                                ? 'w-2/5'
                      ...
                      <div className='flex  gap-4 py-6 px-7 border-b-2 relative'>
                        ...
                        <div className='flex flex-col gap-3'>
                          ...
                          <div className='flex gap-2 text-[12px]'>
                            ...
                            >
                              Instructor : {currentProgram?.mentor_name}
                            </span>
                          </div>
                          <button
                            className='text-white text-[12px] py-2 w-[90px]'
