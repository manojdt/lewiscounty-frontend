...
export default function ProgramFeeds({ title = 'Program Feeds', feedsList= [] } ) {
    ...
    return (
        <div className='program-feeds' style={{ boxShadow: '4px 4px 15px 0px rgba(0, 0, 0, 0.05)', borderRadius: '10px', paddingBottom: '10px' }}>
